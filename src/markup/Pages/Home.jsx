        ...
        <section className="home-hero" aria-labelledby="hero-title">
          ...
          <div className="hero-right">
            ...
            >
              ...
              <p className="hero-sub" aria-label="Search roadmaps">Explore all skills</p>
              <Link to="/AllRoadmaps">
        ...
        <section className="roadmap-grid" aria-live="polite">
          <article className="card" tabIndex="0">
            ...
            <div className="card-footer">
              ...
              <Link to="/AllRoadmaps#frontend" className="btn">
                View
              </Link>
            </div>
          </article>
          ...
          <article className="card" tabIndex="0">
            ...
            <p className="card-desc">
              Learn Node.js, databases, authentication and API design.
            </p>
            <div className="card-footer">
              <span className="pill">Fundamentals → Pro</span>
              <Link to="/AllRoadmaps#backend" className="btn">
                View
              </Link>
            </div>
          </article>
          ...
          <article className="card" tabIndex="0">
            ...
            <p className="card-desc">
              Understand CI/CD, containers, infra as code and cloud services.
            </p>
            <div className="card-footer">
              <span className="pill">Intro → Expert</span>
              <Link to="/AllRoadmaps#devops" className="btn">
                View
              </Link>
            </div>
          </article>
